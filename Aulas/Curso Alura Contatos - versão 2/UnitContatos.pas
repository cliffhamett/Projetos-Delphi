...
begin
  if not fdcontatos.FindKey([txtProcura.Text]) then
    begin
       ShowMessage('Código informado não foi encontrado.');
    end
  else
    begin
      carrega;
...
begin
  if txtNome.Text = '' then
    begin
      ShowMessage('Campo obrigatório não informado!');
      txtNome.SetFocus;
    end;
end;
...
begin
  ...
  estado := 1; //1 significa que está gravado (post)
end;
